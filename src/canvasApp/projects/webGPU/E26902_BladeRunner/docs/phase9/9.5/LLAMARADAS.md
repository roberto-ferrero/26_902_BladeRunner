...
En «Exterior — Fase 9»: activación, intervalo entre 2 y 60 s (inicial 4,5 s), tamaño entre 1× y 5× (inicial 3,5×), crecimiento vertical entre 1× y 3× (inicial 2×) e intensidad entre 0 y 1,5 (inicial 0,65). Intensidad cero y desactivación apagan todo el efecto. Ocultar los edificios bajos oculta también las emisiones para evitar fuego flotante sin torre.
