...
**Arranque actualizado — fase 10 R03:** GUI oculta con botón «Abrir GUI»; cabecera, FPS y LOD efectivo siempre visibles. El GPU Score inicia uno de cinco perfiles; si el rendimiento sostenido baja de 55 FPS, el modo automático reduce resolución y, si no basta, LOD para aproximarse a 60 FPS. Manual fijo y modo Auto/Escritorio/Móvil independiente. [Presupuestos, comportamiento y límites](docs/phase10/R03_AUTO.md). Paneo horizontal 2 m, vertical 0,5 m y suavidad 1,4 s. Los controles conservan sus valores al ocultarse.
